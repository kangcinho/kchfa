...
class GroupingEmiten{
    public function groupingFinancialByEmiten($financialData){
    ...
    private function dataRasio($financial){
        ...
        $dataRasio->pricePerUnitCurrency = $financial->pricePerUnitCurrency;
        $dataRasio->price = $financial->price;
        $dataRasio->currencyName = $financial->currencyName;
        $dataRasio->currencies = $financial->currencies;
